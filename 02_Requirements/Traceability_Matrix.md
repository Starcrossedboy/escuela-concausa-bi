...
| REQ | Historias | Evidencia de prueba | DevLog | Estado |
|---|---|---|---|---|
| `REQ-003` | `US-311`, `US-312` | Drivers usados/excluidos publicados en `Evaluacion_Modelos.md` §5 y §5.1 y registrados en MLflow (`cobertura_drivers`, `drivers_sin_datos` por ventana) ✅ · regresión: el reporte no podía generarse con un driver excluido porque predecía con los 6 ✅ · 6 pruebas nuevas · suite 507 ✅ | [[_DevLog/2026-08-28-hector-morales-drivers-en-evaluacion]] | 🟡 En progreso |
