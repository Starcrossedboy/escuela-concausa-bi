...
va en S4/S5. **US-004** (matriz de trazabilidad) se mantiene `in_review` por ser un artefacto de
mantenimiento continuo. Para US de documentación/diseño, la "prueba" de Definition of Done la cubren la
revisión del Tech Lead responsable, `vault_lint` y TEST-002.
