...
| US-311 | in_progress | 2026-08-08 | — | [[_DevLog/2026-08-13-hector-morales-entrenamiento-ml01]] · PR #28 (ML-01 entrenado, **MAE 0.0141 / RMSE 0.0177**, TEST-005) · PR #8 · PR #21; MLflow ya alineado a 3.15.1 (PR #45, **BLOCK-001 mitigating**) — falta que Héctor re-corra y confirme el registry end-to-end para cerrar AC-003.4; **objetivo de predicción definido por DEC-007** e **implementado a nivel `municipio × nivel`** (PR #56, `target_hibrido.py`, **TEST-009**, 18 casos) sobre fixture — objetivo real pendiente de la **serie SNIEE** (gate 30-ago) | 2026-08-20 |
