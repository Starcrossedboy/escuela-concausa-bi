...
| `US-113` | Construir los cubos de agregacion | 🔴 Bloqueado | 85% | DEC-009 no canónico en `origin/main`; `cubo_pipeline` sin relación dbt canónica de metadata de ingesta | Dom 23 ago |
