...
| `US-113` | Construir los cubos de agregacion | 🔴 Bloqueado | 92% | `cubo_pipeline` / DB-10 sin relación dbt canónica de metadata de ingesta; DEC-009 ya no bloquea materialización por autorización explícita de la owner | Dom 23 ago |
