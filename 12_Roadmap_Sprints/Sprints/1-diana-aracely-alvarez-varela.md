...
| **Formato de entrega** | Rama `feat/diana-varela-...` → PR con plantilla completa → 1 aprobación (PM) → merge a `main` |
...
| `US-106` | Congelar esquema y documentar linaje compl | ✅ Terminado | 100% | — | Dom 6 sep |
