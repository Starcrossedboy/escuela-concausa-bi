...
| **Formato de entrega** | Rama `feat/juan-mayen-...` → PR con plantilla completa → 1 aprobación (PM) → merge a `main` |
...
| `US-416` | Implementar cache y manejo de errores de i | 🔵 En revisión (PR pendiente de abrir) | 100% | — | Dom 6 sep |
