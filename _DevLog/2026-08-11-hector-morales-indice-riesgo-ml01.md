...
- [[03_Architecture/Data_Model]] §4.5 lo declara como `valor` de `gold.predicciones`.
- [[04_UX_Design/Screen_Specs]] cuenta "escuelas en riesgo" con `indice_riesgo >= 0.6`.
...
- `tests/test_riesgo.py` — 16 casos ([[15_ML_Models/Indice_Riesgo_ML01|TEST-004]]).
- [[15_ML_Models/Indice_Riesgo_ML01]] — especificación, en `in_review` y con lo pendiente de
  ratificar explícito.
...
[[04_UX_Design/Screen_Specs]] ya usaba. Las constantes de la sigmoide se derivan de las anclas al
...
- **Archivos creados/modificados:** `src/modelos/riesgo.py`, `tests/test_riesgo.py`,
  `15_ML_Models/Indice_Riesgo_ML01.md`, `15_ML_Models/_index.md`,
...
- **Correcciones manuales:** revisión línea por línea. Se detectaron y corrigieron dos cosas:
  ...
  2. Bug de formato preexistente en `15_ML_Models/_index.md`: la sección `## Documentos` que
...
- **US-311 figura como `done`** en [[12_Roadmap_Sprints/Execution_Status]] desde el cierre de
