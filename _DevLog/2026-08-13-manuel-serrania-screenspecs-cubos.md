...
`15_ML_Models/Indice_Riesgo_ML01.md` y pidió ratificar el umbral de negocio **0.6 = perder ~5% de
...
- **`04_UX_Design/Screen_Specs.md`** (corrección US-201):
...
- **`02_Requirements/Traceability_Matrix.md`**: columna DevLog de REQ-002 → referencia la corrección.
...
- **Archivos creados/modificados:**
  ...
  - `_DevLog/2026-08-13-manuel-serrania-screenspecs-cubos.md` (nuevo)
  - `_DevLog/_index.md`
  - `02_Requirements/Traceability_Matrix.md`
  - `12_Roadmap_Sprints/Sprints/2-manuel-alejandro-serrania-reinada.md`
...
- **Pendiente de coordinación (no editado por Manuel):**
  - `03_Architecture/Data_Model.md` §4.5/§5.1 (columna `indice_riesgo`) → Diana (C1).
  - `15_ML_Models/Indice_Riesgo_ML01.md` `in_review` → `approved` → Héctor (C3).
  - `DEC-005` en `10_Risk_Governance/Decision_Log.md` → PM.
