...
- `tests/test_publicar_gold.py` — 18 casos ([[15_ML_Models/Publicacion_Gold|TEST-006]]).
- [[15_ML_Models/Publicacion_Gold]] — documento del job, en `in_review`.
...
- **Archivos creados/modificados:** `src/modelos/publicar_gold.py`, `tests/test_publicar_gold.py`,
  `15_ML_Models/Publicacion_Gold.md`, `15_ML_Models/_index.md`,
...
`vault_lint` marcó un ID duplicado: apareció `15_ML_Models/ML01_Entrenamiento 2.md`, copia local
