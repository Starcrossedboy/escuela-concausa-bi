...
- Creado: `07_Security/Threat_Model.md` (11 KB)
...
### Documentación
- `07_Security/Threat_Model.md` (11 KB) — Threat model completo
...
**Solución:** Mover a `07_Security/Threat_Model.md` con frontmatter  
**Tiempo:** 15 min
...
- US-502: Docker Compose completo
- [[07_Security/Threat_Model]]: Documentación de amenazas
- [[07_Security/Credentials_Policy]]: Política de credenciales
