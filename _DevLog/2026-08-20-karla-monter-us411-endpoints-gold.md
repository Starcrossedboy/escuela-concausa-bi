...
→ [[_DevLog/_index|Volver al índice]] · [[03_Architecture/API_Specification|API_Spec §3.3]]
...
`04_UX_Design/Screen_Specs.md` (KPI-02 variación ponderada, KPI-04 escuelas en riesgo vía JOIN a
...
**5. Contrato y OpenAPI:** `03_Architecture/API_Specification.md` §3.3 y §4 sincronizados con cada
...
- **Modificados:** `src/api/config.py`, `src/api/schemas.py`, `src/api/v1/gold.py`,
  `tests/test_api_contract.py`, `03_Architecture/API_Specification.md`, `api/openapi.v1.json`.
