...
configuración del repositorio. Se registran en [[06_Quality_Testing/Bug_Register]] siguiendo el flujo
de intake de [[_Meta/Definition_of_Filed]].
...
- **Archivos creados/modificados:**
  ...
  - `_DevLog/2026-08-21-marina-garcia-ambiente-local-bugs.md` (nuevo) · `_DevLog/_index.md`
