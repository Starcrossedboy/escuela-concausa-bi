...
- `06_Quality_Testing/Automated/Great_Expectations_DS05_Sinaica.md`,
  `Great_Expectations_DS04_Sesnsp.md` — sección de cobertura automatizada.
- `12_Roadmap_Sprints/Sprints/1-luis-enrique-garcia-vazquez.md` — `US-124b` a Terminado.
- `02_Requirements/Traceability_Matrix.md` — fila `REQ-001`.
- `_DevLog/2026-08-24-luis-garcia-us124b-fixtures-ds04-ds05.md` (este archivo).
