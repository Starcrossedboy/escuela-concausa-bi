...
→ [[_DevLog/_index|Volver al índice]] · [[03_Architecture/ADRs/ADR-004-autenticacion-oauth2-jwt|ADR-004 §RBAC]] · [[03_Architecture/API_Specification|API_Spec §3]]
...
- **Modificados:** `src/api/config.py` (+flag), `src/api/v1/__init__.py` (wiring RBAC),
  ...
  `03_Architecture/ADRs/ADR-004-autenticacion-oauth2-jwt.md` (§RBAC).
