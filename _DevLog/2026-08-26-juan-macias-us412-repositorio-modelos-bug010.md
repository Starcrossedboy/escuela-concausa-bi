...
## Qué se hizo
- Investigando US-412 encontré que ya existía **BUG-010** (`06_Quality_Testing/Bug_Register.md`,
...
- `tests/fixtures_modelos.py` (nuevo): `RepositorioModelosFake`, mismo patrón que
  ...
  `03_Architecture/API_Specification.md` y `api/openapi.v1.json` actualizados.
  `06_Quality_Testing/Bug_Register.md`: BUG-010 → `fixed`, con nota de resolución.
...
- **Archivos creados/modificados:**
  ...
  - `03_Architecture/API_Specification.md`, `api/openapi.v1.json`
...
- Actualizar `02_Requirements/Traceability_Matrix.md` (fila REQ-004) -- coordinar con Edgar
