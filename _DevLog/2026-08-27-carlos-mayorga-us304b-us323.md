...
1. **`_DevLog/2026-08-27-handoff-us304b.md`: borrado.** No tenía frontmatter, así que reprobaba
...
2. **Conflicto de `15_ML_Models/_index.md`: resuelto.** `main` había reescrito las descripciones de
