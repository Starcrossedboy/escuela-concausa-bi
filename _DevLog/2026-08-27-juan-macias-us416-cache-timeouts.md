...
- `03_Architecture/API_Specification.md`: §5 (fila 503) y §3.4 (columna Códigos de ambas rutas).
...
- **Archivos creados/modificados:**
  ...
  - `12_Roadmap_Sprints/Sprints/4-juan-carlos-macias-mayen.md`
...
- Actualizar `02_Requirements/Traceability_Matrix.md` (fila REQ-004) -- coordinar con Edgar Coronel
