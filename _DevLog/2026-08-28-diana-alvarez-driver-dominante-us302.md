...
`15_ML_Models/Preguntas_Coordinacion_C3.md` que Célula 1 publicara una etiqueta real para entrenar
...
`03_Architecture/Data_Model.md` §5.3 actualizado con la misma nota aclaratoria: este
...
`06_Quality_Testing/Automated/Evaluacion_Modelos.md` (dueño: Héctor Morales Marbán). Ese archivo
