...
**Hice:** [[03_Architecture/ADRs/ADR-007-unidad-target-variacion-matricula|ADR-007]] como
...
- **Archivos modificados:** `03_Architecture/ADRs/ADR-007-*` (nuevo), `03_Architecture/ADRs/_index.md`,
  `src/modelos/riesgo.py`, `06_Quality_Testing/Bug_Register.md`,
