...
- `06_Quality_Testing/Bug_Register.md` — BUG-015, BUG-016
- `12_Roadmap_Sprints/Sprints/2-monserrat-xcaret-miranda-olivas.md` — §9 actualizado (US-211b 100%,
  US-213 en curso)
- `02_Requirements/Traceability_Matrix.md` — fila REQ-002, evidencia de US-213
- `_DevLog/_index.md`
