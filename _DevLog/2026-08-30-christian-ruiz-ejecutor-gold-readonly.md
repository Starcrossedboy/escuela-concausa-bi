...
→ [[_DevLog/_index|Volver al índice]] · [[03_Architecture/ADRs/ADR-004-autenticacion-oauth2-jwt|ADR-004 §Hardening]] · [[06_Quality_Testing/Bug_Register|BUG-025]]
...
- **Modificados:** `src/api/config.py`, `src/api/app.py`, `.env.example`,
  `03_Architecture/ADRs/ADR-004-autenticacion-oauth2-jwt.md`, `_DevLog/_index.md`.
