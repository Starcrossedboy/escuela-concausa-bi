...
→ [[vault/03_Architecture/ADRs/_index|Volver a ADRs]] · [[vault/03_Architecture/Data_Model|Data_Model §3/§7]]
...
- **D6 (aire):** usa `PM2.5` como proxy de calidad del aire — el contaminante criterio más
  reportado por SINAICA (ver `vault/14_Data_Sources/DS-05_SINAICA_Calidad_Aire.md` §5, prueba de
...
- Historia: US-105
- Impacta: [[vault/03_Architecture/Data_Model]] §3/§7 · `dbt/models/gold/fact_escuela_ciclo.sql` ·
  `dbt/models/gold/features_escuela.sql` · `dbt/seeds/dim_driver.csv`
- Relacionado: [[vault/03_Architecture/ADRs/ADR-005-dim-driver-mapeo|ADR-005]] (mismo patrón de mapeo
