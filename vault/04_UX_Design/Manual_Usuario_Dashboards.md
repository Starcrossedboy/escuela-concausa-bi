...
![DB-07 · Calidad y cobertura de datos, capturado en local tras el fix de BUG-050](capturas/db07-calidad-cobertura.png)

**Captura real, 2026-09-04**, tomada contra Superset local tras el fix de **BUG-050**: el filtro
...
igual antes del fix, así que el porcentaje ya era confiable. Detalle completo en `BUG-050`
