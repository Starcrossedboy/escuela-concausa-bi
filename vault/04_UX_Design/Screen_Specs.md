...
status: in_review
traces_up: ["DOC-US", "vault/02_Requirements/Requirements_Detailed", "vault/01_Product/PRD"]
...
> → [[vault/04_UX_Design/_index]] · Fuentes canónicas: [[vault/03_Architecture/Data_Model]] · [[vault/01_Product/PRD]]
...
> Catálogo canónico ratificado en [[vault/01_Product/PRD]] §12. Cada tablero traza a la historia que lo
> construye y al cubo de Gold que lo alimenta ([[vault/03_Architecture/Data_Model]] §4.3).
...
row-level security ([[vault/03_Architecture/Frontend_Architecture]] · ADR-002). El andamiaje actual define las
...
> literalmente "sin dato disponible". Ratificado el 2026-08-15 (ref. [[vault/04_UX_Design/Cube_Specs_DB03_DB04]]
...
matrícula equivale a un riesgo de 0.60 (ver [[vault/15_ML_Models/Indice_Riesgo_ML01]]).
...
riesgo ratificado: 0.6 = perder ~5% de matrícula (ver [[vault/15_ML_Models/Indice_Riesgo_ML01]]).
...
> (ref. `vault/04_UX_Design/Cube_Specs_DB05_DB08.md` §8.3 — PR #73; convertir a wikilink al integrarse).
...
- **Consume:** [[vault/03_Architecture/Data_Model]] (esquema Gold y cubos) · [[vault/01_Product/PRD]] (§12 catálogo DB)
