...
status: implemented
traces_up: ["vault/02_Requirements/User_Stories", "vault/02_Requirements/Requirements_Detailed"]
...
> [[vault/02_Requirements/User_Stories|US-123b]]. Complementa
> [[vault/06_Quality_Testing/Automated/Great_Expectations_DS05_Sinaica|TEST-010]] (DS-05), cerrando
> Great Expectations para ambas fuentes de la Célula 1 que le tocan a Luis.
> → [[vault/06_Quality_Testing/Automated/_index]] · [[vault/14_Data_Sources/DS-04_SESNSP_Incidencia_Delictiva]]
...
`vault/14_Data_Sources/DS-04_SESNSP_Incidencia_Delictiva.md` sección 10 para el porqué):
...
- `vault/14_Data_Sources/DS-04_SESNSP_Incidencia_Delictiva.md` para la historia completa del bloqueo de
