...
> [[vault/02_Requirements/User_Stories|US-311]] mientras la Célula 1 publica `gold.features_escuela`.
> → [[vault/06_Quality_Testing/Automated/_index]] · [[vault/15_ML_Models/_index]]
...
[[vault/03_Architecture/Data_Model|Data_Model §5.3]], que produce la Célula 1. Cuando Diana Alvarez
