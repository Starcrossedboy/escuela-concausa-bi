...
> Unit, integración y E2E. Cada caso usa [[vault/_Templates/Test_Case_template]].
...
| [[vault/06_Quality_Testing/Automated/Particion_Temporal_ML01\|TEST-003]] | US-311 · REQ-003 · AC-003.3 | unit | implemented |
| [[vault/15_ML_Models/Indice_Riesgo_ML01\|TEST-004]] | US-311 · REQ-003 · US-401 (contrato API) | unit | implemented |
| [[vault/15_ML_Models/ML01_Entrenamiento\|TEST-005]] | US-311 · REQ-003 · AC-003.2/003.3 | unit | implemented |
| [[vault/15_ML_Models/Publicacion_Gold\|TEST-006]] | US-313 · REQ-003 · DEC-005 | integración | implemented |
| [[vault/06_Quality_Testing/Automated/Evaluacion_Modelos\|TEST-007]] | US-312 · REQ-003 · AC-003.2 | unit | implemented |
| TEST-008 | US-104 · US-311 · REQ-001/003 | contrato | implemented |
| [[vault/15_ML_Models/Target_Hibrido\|TEST-009]] | US-311 · US-313 · DEC-007 · RISK-007 | unit | implemented |
| [[vault/06_Quality_Testing/Automated/Great_Expectations_DS05_Sinaica\|TEST-010]] | US-123b · REQ-001 | data quality | implemented |
| [[vault/06_Quality_Testing/Automated/Great_Expectations_DS04_Sesnsp\|TEST-011]] | US-123b · REQ-001 | data quality | implemented |

`TEST-002` ejecuta `python3 vault/_Meta/scripts/validate_pm_dashboard.py .` y verifica 87 US únicas,
...
falle la API. Su especificación vive en [[vault/15_ML_Models/Indice_Riesgo_ML01]].

`TEST-007` (`tests/test_evaluar.py`, 26 casos) respalda
[[vault/06_Quality_Testing/Automated/Evaluacion_Modelos]], que **se genera desde el código** con
...
[[vault/06_Quality_Testing/Automated/Great_Expectations_DS05_Sinaica]] para el detalle y cómo reproducir.
