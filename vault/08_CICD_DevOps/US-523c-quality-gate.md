...
2. **Vault Limpio:** Ejecuta el script `vault/_Meta/scripts/vault_lint.py .` para asegurar que las reglas documentales del repositorio se cumplan antes de integrar el código.
