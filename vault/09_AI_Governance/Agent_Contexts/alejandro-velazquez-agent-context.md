...
status: approved
traces_up: ["vault/12_Roadmap_Sprints/Sprints/5-alejandro-velazquez-mendoza"]
...
> → [[vault/09_AI_Governance/AI_Agent_Governance]] · Plan: [[vault/12_Roadmap_Sprints/Sprints/5-alejandro-velazquez-mendoza]]
...
| **Identidad** | `alejandro-velazquez` |
| **Rama fija** | `dev/alejandro-velazquez` — permanente, no se borra al mergear |
...
- **DevLog obligatorio por sesión con IA**, antes del push (`vault/_DevLog/YYYY-MM-DD-alejandro-velazquez-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR desde su rama fija `dev/alejandro-velazquez`.
...
- **Nunca `rebase` ni `--force`** sobre `dev/alejandro-velazquez`.
