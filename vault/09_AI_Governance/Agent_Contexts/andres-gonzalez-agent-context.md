...
status: approved
traces_up: ["vault/12_Roadmap_Sprints/Sprints/3-andres-gonzalez-habib"]
...
> → [[vault/09_AI_Governance/AI_Agent_Governance]] · Plan: [[vault/12_Roadmap_Sprints/Sprints/3-andres-gonzalez-habib]]
...
| **Identidad** | `andres-gonzalez` |
| **Rama fija** | `dev/andres-gonzalez` — permanente, no se borra al mergear |
...
| `requirements/celula-3.txt` | dueño del área | cambio acotado; avisar en el PR |
...
- **DevLog obligatorio por sesión con IA**, antes del push (`vault/_DevLog/YYYY-MM-DD-andres-gonzalez-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR desde su rama fija `dev/andres-gonzalez`.
...
- **Nunca `rebase` ni `--force`** sobre `dev/andres-gonzalez`.
