...
status: approved
traces_up: ["vault/12_Roadmap_Sprints/Sprints/1-emilio-galnares-ruiz"]
...
> → [[vault/09_AI_Governance/AI_Agent_Governance]] · Plan: [[vault/12_Roadmap_Sprints/Sprints/1-emilio-galnares-ruiz]]
...
| **Identidad** | `emilio-galnares` |
| **Rama fija** | `dev/emilio-galnares` — permanente, no se borra al mergear |
...
| ID | Sprint | Objetivo |
|---|---|---|
| US-121a | S1 | SOLO tus fuentes DS-06 y DS-08: descargar fisicamente, abrir, contar registros, verificar esquema y llave (clave INEGI 5 digitos) y llenar la prueba en `vault/14_Data_Sources/DS-06_CONAGUA_SINA.md` y `DS-08_CONAPO_Proyecciones.md`. |
...
- **DevLog obligatorio por sesión con IA**, antes del push (`vault/_DevLog/YYYY-MM-DD-emilio-galnares-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR desde su rama fija `dev/emilio-galnares`.
...
- **Nunca `rebase` ni `--force`** sobre `dev/emilio-galnares`.
