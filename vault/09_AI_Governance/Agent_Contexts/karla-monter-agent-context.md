...
status: approved
traces_up: ["vault/12_Roadmap_Sprints/Sprints/4-karla-alejandra-monter-benitez"]
...
> → [[vault/09_AI_Governance/AI_Agent_Governance]] · Plan: [[vault/12_Roadmap_Sprints/Sprints/4-karla-alejandra-monter-benitez]]
...
| **Identidad** | `karla-monter` |
| **Rama fija** | `dev/karla-monter` — permanente, no se borra al mergear |
...
- **DevLog obligatorio por sesión con IA**, antes del push (`vault/_DevLog/YYYY-MM-DD-karla-monter-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR desde su rama fija `dev/karla-monter`.
...
- **Nunca `rebase` ni `--force`** sobre `dev/karla-monter`.
