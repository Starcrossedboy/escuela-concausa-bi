...
status: approved
traces_up: ["vault/12_Roadmap_Sprints/Sprints/5-luis-tellez-dominguez"]
...
> → [[vault/09_AI_Governance/AI_Agent_Governance]] · Plan: [[vault/12_Roadmap_Sprints/Sprints/5-luis-tellez-dominguez]]
...
| **Identidad** | `luis-tellez` |
| **Rama fija** | `dev/luis-tellez` — permanente, no se borra al mergear |
...
- **DevLog obligatorio por sesión con IA**, antes del push (`vault/_DevLog/YYYY-MM-DD-luis-tellez-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR desde su rama fija `dev/luis-tellez`.
...
- **Nunca `rebase` ni `--force`** sobre `dev/luis-tellez`.
