...
status: approved
traces_up: ["vault/12_Roadmap_Sprints/Sprints/2-manuel-alejandro-serrania-reinada"]
...
> → [[vault/09_AI_Governance/AI_Agent_Governance]] · Plan: [[vault/12_Roadmap_Sprints/Sprints/2-manuel-alejandro-serrania-reinada]]
...
| **Identidad** | `manuel-serrania` |
| **Rama fija** | `dev/manuel-serrania` — permanente, no se borra al mergear |
...
- `vault/04_UX_Design/**`
- `src/frontend/**` (FARO Web: shell, panel ML, chat, auth)
...
| ID | Sprint | Objetivo |
|---|---|---|
| US-201 | S1 | Arquitectura de informacion de los 10 tableros, arbol de navegacion y definicion formal de cada KPI con su formula SQL. Documentar en `vault/04_UX_Design/Screen_Specs.md`. |
...
- **DevLog obligatorio por sesión con IA**, antes del push (`vault/_DevLog/YYYY-MM-DD-manuel-serrania-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR desde su rama fija `dev/manuel-serrania`.
...
- **Nunca `rebase` ni `--force`** sobre `dev/manuel-serrania`.
