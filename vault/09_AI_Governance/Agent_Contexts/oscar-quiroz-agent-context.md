...
status: approved
traces_up: ["vault/12_Roadmap_Sprints/Sprints/2-oscar-antonio-quiroz-lazaro"]
...
> → [[vault/09_AI_Governance/AI_Agent_Governance]] · Plan: [[vault/12_Roadmap_Sprints/Sprints/2-oscar-antonio-quiroz-lazaro]]
...
| **Identidad** | `oscar-quiroz` |
| **Rama fija** | `dev/oscar-quiroz` — permanente, no se borra al mergear |
...
- **DevLog obligatorio por sesión con IA**, antes del push (`vault/_DevLog/YYYY-MM-DD-oscar-quiroz-*.md`).
...
- **Nunca commit directo a `main`**: todo entra por PR desde su rama fija `dev/oscar-quiroz`.
...
- **Nunca `rebase` ni `--force`** sobre `dev/oscar-quiroz`.
