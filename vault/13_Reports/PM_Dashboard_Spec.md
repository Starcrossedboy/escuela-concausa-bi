...
traces_up: ["US-004", "REQ-007", "vault/12_Roadmap_Sprints/PLAN_MAESTRO", "vault/00_Start_Here/Developer_Onboarding"]
traces_down: ["vault/13_Reports/TABLERO_CONTROL_PM.html", "TEST-002"]
...
> una fuente de verdad. → [[vault/13_Reports/_index]] · [[vault/12_Roadmap_Sprints/Execution_Status]]
...
Fuentes canónicas Markdown + Git local/GitHub
                 ↓
vault/_Meta/scripts/generate_pm_dashboard.py
                 ↓
vault/13_Reports/data/pm-dashboard.json (snapshot auditable)
                 ↓
vault/13_Reports/TABLERO_CONTROL_PM.html (autocontenido y offline)
```
...
|---|---|---|
| Requisitos y puntos | [[vault/02_Requirements/User_Stories]] · [[vault/02_Requirements/Traceability_Matrix]] | REQ, rúbrica, cobertura |
| Catálogo de trabajo | [[vault/02_Requirements/User_Stories]] | US, título, responsable, célula, sprint |
| Ejecución | [[vault/12_Roadmap_Sprints/Execution_Status]] | estado, fechas, bloqueo, evidencia |
| Plan individual | [[vault/12_Roadmap_Sprints/Sprints/_index]] | misión, objetivos, inputs, outputs, revisor y entregables |
| Directorio GitHub | [[vault/00_Start_Here/Developer_Onboarding]] | usuario GitHub confirmado o pendiente por integrante |
| Responsabilidad | [[vault/12_Roadmap_Sprints/RACI]] | R/A/C/I y gate |
| Dependencias | [[vault/12_Roadmap_Sprints/PLAN_MAESTRO]] · [[vault/10_Risk_Governance/Blocker_Register]] | cadena, bloqueo, aging |
| Entrega final | [[vault/12_Roadmap_Sprints/PLAN_MAESTRO]] | `delivery_date`, etiqueta y zona horaria del contador |
| Riesgos | [[vault/10_Risk_Governance/Risk_Register]] | probabilidad, impacto, respuesta, trigger |
| Fuentes de datos | [[vault/14_Data_Sources/_index]] y notas `DS-*.md` | owner, frecuencia, prueba, cobertura |
| Calidad y gobierno | [[vault/05_Engineering/Definition_of_Done]] · [[vault/_DevLog/_index]] | gates, evidencia |
| Actividad Git | snapshot efímero generado por `vault/_Meta/scripts/collect_github_activity.py` | PR autorados y CI; nunca determina `done` por sí sola |
