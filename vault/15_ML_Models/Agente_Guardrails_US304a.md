...
status: in_review
version: "0.5"
traces_up: ["US-304a", "REQ-006", "vault/03_Architecture/API_Specification"]
...
> → [[vault/15_ML_Models/_index]] · Contrato API: [[vault/03_Architecture/API_Specification]]
...
El contrato canónico de `vault/03_Architecture/API_Specification.md` y `api/openapi.v1.json` no define un
