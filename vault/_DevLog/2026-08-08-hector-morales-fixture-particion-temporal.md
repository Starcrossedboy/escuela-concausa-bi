...
`main` (ver [[vault/_DevLog/2026-08-07-edgar-remediacion-sprint1]]).
...
([[vault/06_Quality_Testing/Automated/Particion_Temporal_ML01|TEST-003]]).
...
- **Archivos creados/modificados:**
  ...
  - `vault/06_Quality_Testing/Automated/Particion_Temporal_ML01.md` (+ su `_index`)
  - `requirements/celula-3.txt`
