...
- Creado **ADR-003** (`vault/03_Architecture/ADRs/ADR-003-ml-estrategia-modelado.md`): decisión de arquitectura de modelado ML. Cubre partición temporal walk-forward, backtesting por fold y manejo de cobertura parcial (D5/D6) con indicador binario + imputación de mediana. Registrado en `vault/03_Architecture/ADRs/_index.md`.
- Creado **`vault/15_ML_Models/ML_Strategy.md`**: protocolo completo de modelado con schema esperado de `gold.features_escuela`, tabla de umbrales de aceptación provisional, estructura del output de SHAP para ML-02 y convención de nombres en MLflow. Registrado en `vault/15_ML_Models/_index.md`.
