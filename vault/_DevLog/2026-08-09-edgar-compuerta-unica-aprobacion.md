...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/10_Risk_Governance/Decision_Log]] · [[vault/05_Engineering/Branching_Strategy]]
...
- **`vault/10_Risk_Governance/Decision_Log.md`** — nueva entrada **DEC-003** (deja sin efecto la doble compuerta).
- **`vault/05_Engineering/Branching_Strategy.md`** — sección "doble compuerta" reescrita a "compuerta única";
  checklist del PM y sección de protección de `main` actualizadas (1 aprobación + bypass admin).
- **`vault/00_Start_Here/Developer_Onboarding.md`** — flujo de trabajo y nota de CODEOWNERS.
