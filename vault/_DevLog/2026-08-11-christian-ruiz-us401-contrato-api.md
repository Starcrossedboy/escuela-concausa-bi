...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/03_Architecture/API_Specification|API_Spec]] · [[vault/02_Requirements/Traceability_Matrix|Matriz]]

## Contexto

US-401 (Sprint 1) pedía **definir y publicar el contrato de la API** para desbloquear a las Células 2
y 3. El documento de contrato [[vault/03_Architecture/API_Specification]] ya existía y estaba bien, pero su
