...
- `tests/test_entrenar_ml01.py` — 15 casos ([[vault/15_ML_Models/ML01_Entrenamiento|TEST-005]]).
- [[vault/15_ML_Models/ML01_Entrenamiento]] — resultados y protocolo, en `in_review`.
