...
([[vault/04_UX_Design/Cube_Specs_DB03_DB04]]), el SQL de referencia y la capa semántica en `superset/semantic/`.
...
2. **Alta de KPI-15…KPI-18** con los nombres y fórmulas propuestos por Marina en su §5.1, publicados
   como canónicos en `vault/04_UX_Design/Screen_Specs.md` (regla 1: un tema, un archivo canónico).
...
- **`vault/04_UX_Design/Screen_Specs.md`** (catálogo canónico, US-201):
...
- **`vault/02_Requirements/Traceability_Matrix.md`**: celda DevLog de REQ-002 → referencia esta sesión.
...
- **Archivos creados/modificados:**
  ...
  - `vault/_DevLog/2026-08-15-manuel-serrania-kpis-db03-ratificacion-join.md` (nuevo)
...
- [x] `python vault/_Meta/scripts/vault_lint.py .` en verde
