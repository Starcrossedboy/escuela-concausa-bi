...
US-312: tabla comparativa, curvas y análisis de error por entidad, en `vault/06_Quality_Testing/`.
...
- `tests/test_evaluar.py` — 13 casos ([[vault/06_Quality_Testing/Automated/Evaluacion_Modelos|TEST-007]]).
- [[vault/06_Quality_Testing/Automated/Evaluacion_Modelos]] — reporte generado, en `in_review`.
...
- **Archivos creados/modificados:** `src/modelos/evaluar.py`, `tests/test_evaluar.py`,
  `vault/06_Quality_Testing/Automated/Evaluacion_Modelos.md` (generado),
...
- **US-311 figura como `done`** en [[vault/12_Roadmap_Sprints/Execution_Status]] citando el registro en
