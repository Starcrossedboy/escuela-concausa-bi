...
[[vault/06_Quality_Testing/Automated/Evaluacion_Modelos]] para incorporar los umbrales que alineó en
...
- **Archivos modificados:** `vault/06_Quality_Testing/Automated/Evaluacion_Modelos.md` (regenerado),
