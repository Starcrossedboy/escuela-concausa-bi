...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/10_Risk_Governance/Risk_Register]] · [[vault/10_Risk_Governance/Decision_Log]]
...
Hallazgo: [[vault/14_Data_Sources/DS-01_Formato_911]] documenta que la serie del 911 existe desde 1990-91 y que
...
- **Colisión de ID DEC-005.** El target se registró primero como `DEC-005`, pero ese número ya designaba
  ...
  en todo su rastro (Decision_Log, Risk_Register, DS-01, Execution_Status, `vault/15_ML_Models/Target_Hibrido`
...
- **Matriz de trazabilidad de-duplicada.** REQ-002 y REQ-003 aparecían dos veces con contenido distinto por
  ...
  `vault/_DevLog/_index.md`, que sí es log de solo-agregado).
