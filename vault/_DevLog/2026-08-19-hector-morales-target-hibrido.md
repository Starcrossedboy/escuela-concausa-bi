...
## 1. Corrección del estado de MLflow en [[vault/15_ML_Models/ML01_Entrenamiento]]
...
- `tests/test_target_hibrido.py` — 18 casos ([[vault/15_ML_Models/Target_Hibrido|TEST-009]]).
- [[vault/15_ML_Models/Target_Hibrido]] — documento de la implementación.
...
- **Archivos creados/modificados:** `src/modelos/target_hibrido.py`,
  ...
  `tests/fixtures/dim_escuela_mock.csv`, `vault/15_ML_Models/Target_Hibrido.md`,
  `vault/15_ML_Models/ML01_Entrenamiento.md`, `vault/15_ML_Models/_index.md`,
...
1. **Colisión de ID en DEC-005.** El `Decision_Log` tiene un único DEC-005, el del target híbrido
   ...
   `src/modelos/publicar_gold.py`, [[vault/15_ML_Models/Publicacion_Gold]], el registro de TEST-006 y tres
...
> Ver [[vault/10_Risk_Governance/Decision_Log]] y [[vault/_DevLog/2026-08-19-edgar-mitigacion-risk007-target]].
