...
2. Decidí dejar que la expectativa de georreferencia **falle de verdad** en vez de suavizarla con
   ...
   suite en verde.
3. Asigné el ID `TEST-010` después de verificar en `vault/06_Quality_Testing/Automated/_index.md` que
...
- `vault/06_Quality_Testing/Automated/Great_Expectations_DS05_Sinaica.md` — `TEST-010` (nuevo).
- `vault/06_Quality_Testing/Automated/_index.md` — registro de `TEST-010`.
- `vault/14_Data_Sources/DS-05_SINAICA_Calidad_Aire.md` — nuevo riesgo (georreferencia).
- `vault/12_Roadmap_Sprints/Sprints/1-luis-enrique-garcia-vazquez.md` — tabla de seguimiento.
- `vault/02_Requirements/Traceability_Matrix.md` — fila `REQ-001`, columnas Test y DevLog.
- `vault/_DevLog/2026-08-21-luis-garcia-us123b-great-expectations-ds05.md` (este archivo).
