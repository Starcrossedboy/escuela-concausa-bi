...
- **BUG-009 encontrado, investigado y registrado** (renumerado desde BUG-008 el 22-ago por
  ...
  formalmente en `vault/06_Quality_Testing/Bug_Register.md` (owner: Edgar).
...
- Bug re-aplicado (numerado BUG-008 en ese momento, renumerado a BUG-009 el 22-ago, ver
  "Reconciliación" abajo) a `vault/06_Quality_Testing/Bug_Register.md` (fila + detalle) desde el
...
Resultado, documentado con evidencia en `vault/14_Data_Sources/DS-01_Formato_911.md` §9/§9a:
...
- **Vault:** `vault_lint.py` ya reportaba `✅ Vault limpio` (huérfanos son solo informativos, no
  fallan el script). Se enlazó además este mismo DevLog desde `vault/_DevLog/_index.md` (fila nueva),
...
- **Archivos creados/modificados:**
  ...
  - `vault/06_Quality_Testing/Bug_Register.md` (registro de BUG-009, numerado BUG-008 en el momento
    de esta sesión)
...
- ~~Rama... no pusheada~~ **resuelto 2026-08-22**: Diana pusheó `feat/diana-varela-matricula-historica-risk007`
  ...
  `vault/06_Quality_Testing/Bug_Register.md` (divergencia real: filas de BUG-005/006/007 ya actualizadas
...
- Su tabla de autoseguimiento en `vault/12_Roadmap_Sprints/Sprints/1-diana-aracely-alvarez-varela.md`
...
- Actualizar `vault/12_Roadmap_Sprints/Sprints/1-diana-aracely-alvarez-varela.md` §9 (tabla de
