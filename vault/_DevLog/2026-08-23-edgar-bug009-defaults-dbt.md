...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/06_Quality_Testing/Bug_Register]] · [[vault/10_Risk_Governance/Decision_Log]]
...
[[vault/07_Security/Secrets_Policy]]). Instala solo `dbt-core`/`dbt-postgres` clavados, no
...
- **Archivos modificados:** `dbt/models/sources.yml`, `dbt/dbt_project.yml`,
  `.github/workflows/ci.yml`, `vault/06_Quality_Testing/Bug_Register.md`,
  `vault/10_Risk_Governance/Decision_Log.md`, `vault/02_Requirements/Traceability_Matrix.md`,
  `vault/03_Architecture/Data_Lineage_US106.md`, `vault/_DevLog/_index.md`, este archivo.
