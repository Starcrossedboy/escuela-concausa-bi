...
- **BUG-010** en [[vault/06_Quality_Testing/Bug_Register]], severidad `high`, owner Célula 4, con el mapeo
  completo y el hueco de `cluster`.
- [[vault/06_Quality_Testing/Guion_E2E_Verificacion_4]] — guion ejecutable del tramo de la C3.
...
- **Archivos creados/modificados:** `vault/06_Quality_Testing/Guion_E2E_Verificacion_4.md`,
  `vault/06_Quality_Testing/Bug_Register.md`, `vault/06_Quality_Testing/_index.md`
