...
- `vault/06_Quality_Testing/Automated/Great_Expectations_DS04_Sesnsp.md` — `TEST-011` (nuevo).
- `vault/06_Quality_Testing/Automated/_index.md` — registro de `TEST-011`.
- `vault/14_Data_Sources/DS-04_SESNSP_Incidencia_Delictiva.md` — fuente alterna, esquema real, prueba de
  descarga completada, riesgos nuevos.
- `vault/12_Roadmap_Sprints/Sprints/1-luis-enrique-garcia-vazquez.md` — `US-122b`/`US-123b` a Terminado.
- `vault/02_Requirements/Traceability_Matrix.md` — fila `REQ-001`.
- `vault/_DevLog/2026-08-24-luis-garcia-us122b-us123b-sesnsp-fuente-alterna.md` (este archivo).
