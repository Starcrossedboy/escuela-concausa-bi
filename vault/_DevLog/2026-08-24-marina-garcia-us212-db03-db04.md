...
- **Archivos creados/modificados:**
  ...
  - `vault/02_Requirements/Traceability_Matrix.md` · `vault/12_Roadmap_Sprints/Sprints/2-marina-garcia-del-buey.md`
  - `vault/_DevLog/2026-08-24-marina-garcia-us212-db03-db04.md` (nuevo) · `vault/_DevLog/_index.md`
...
3. **Referencia rota en la guía:** `vault/04_UX_Design/Superset_Setup_US202.md` §2 manda correr
...
- `vault/04_UX_Design/Cube_Specs_DB03_DB04.md` §4.4: se corrigieron **dos** fórmulas —`pct_escuelas_en_riesgo`
