...
- `vault/04_UX_Design/US221_KPIs_Base.md`: documentación del artefacto con frontmatter.
...
- **Confirmar con Manuel (Tech Lead C2):** si DB-01 Ejecutivo (US-203) va a
  ...
  pendiente en `vault/04_UX_Design/US221_KPIs_Base.md` §3.
...
- Actualizar mi fila en `vault/02_Requirements/Traceability_Matrix.md` y el
  `_index.md` de `vault/04_UX_Design/`.
