...
- Se documentó el avance de US-322 y US-325 sobre el fixture sintético en `vault/15_ML_Models/`.
...
- Pedir al dueño de `vault/15_ML_Models/_index.md` y al PM registrar los nuevos artefactos.
