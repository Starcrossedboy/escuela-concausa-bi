...
Diana confirmó que el arreglo de [[vault/_DevLog/2026-08-27-hector-morales-bug015-segunda-vuelta|BUG-015]]
...
- **Archivos modificados:** `src/modelos/publicar_gold.py`, `src/modelos/riesgo.py`,
  `tests/test_publicar_gold.py`, `tests/test_riesgo.py`, `vault/06_Quality_Testing/Bug_Register.md`,
