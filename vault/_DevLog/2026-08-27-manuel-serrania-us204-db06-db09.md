...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/04_UX_Design/Cube_Specs_DB06_DB09]] · [[vault/04_UX_Design/Screen_Specs]] · [[vault/03_Architecture/Data_Model]]
...
- **AVISO al PM (Edgar):** `Traceability_Matrix.md` (REQ-002) y `vault/04_UX_Design/_index.md` son
