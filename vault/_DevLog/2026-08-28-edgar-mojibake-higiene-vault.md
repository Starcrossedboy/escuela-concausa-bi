...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/_Meta/Vault_Rules]] · [[vault/06_Quality_Testing/Bug_Register]]
...
El PR #102 llegó reescribiendo las **227 filas** de `vault/_DevLog/_index.md` con el texto doble
...
- **`graphify-out/`** no se toca. Se revisó y **está versionado a propósito**: es el mapa que
  ...
  resolvió documentándolo en [[vault/_Meta/Vault_Rules]], no ignorando los archivos.
...
- **Archivos modificados:** `vault/_Meta/scripts/vault_lint.py`, `vault/_Meta/Vault_Rules.md`,
  ...
  `.gitignore`,
  `vault/06_Quality_Testing/Bug_Register.md`, `vault/_DevLog/_index.md`, este archivo.
...
- [x] `python vault/_Meta/scripts/generate_pm_dashboard.py .` — 91 US, 21 personas, 8 fuentes
- [x] `python vault/_Meta/scripts/validate_pm_dashboard.py .` — TEST-002 válido
