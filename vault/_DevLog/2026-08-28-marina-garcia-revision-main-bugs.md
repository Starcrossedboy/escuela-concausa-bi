...
en vivo** de [[vault/12_Roadmap_Sprints/PLAN_MAESTRO]], cuya casilla 6 nombra a **DB-03** explícitamente.
...
[[vault/06_Quality_Testing/Bug_Register|BUG-026]], `high`, para **C1**. El arreglo no toca ningún modelo dbt:
...
[[vault/03_Architecture/ADRs/ADR-007-unidad-target-variacion-matricula|ADR-007]] propone fijar la unidad en
...
[[vault/04_UX_Design/Cube_Specs_DB03_DB04]] hay que rehacerlo.

## Hallazgos de proceso

- **Criterio nuevo del 28-ago** en [[vault/12_Roadmap_Sprints/Execution_Status]]: *"las historias cuyo
