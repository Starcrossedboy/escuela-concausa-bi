...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/06_Quality_Testing/Bug_Register|Bug Register · BUG-025]] · [[vault/03_Architecture/API_Specification|API_Spec §3.5]]
...
- **Modificados:** `src/api/v1/agente.py`, `tests/test_api_contract.py`, `vault/_DevLog/_index.md`.
...
- **Edgar (owner de `vault/06_Quality_Testing/Bug_Register.md` y matriz):** actualizar **BUG-025** a
