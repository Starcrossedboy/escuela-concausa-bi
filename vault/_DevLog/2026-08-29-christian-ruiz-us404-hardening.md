...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/03_Architecture/ADRs/ADR-004-autenticacion-oauth2-jwt|ADR-004 §Hardening]] · [[vault/03_Architecture/API_Specification|API_Spec §5]]
...
- **Modificados:** `src/api/app.py` (rate limit + CORS + logging), `src/api/config.py` (settings),
  ...
  `api/openapi.v1.json`, `vault/03_Architecture/ADRs/ADR-004-autenticacion-oauth2-jwt.md`, `vault/_DevLog/_index.md`.
