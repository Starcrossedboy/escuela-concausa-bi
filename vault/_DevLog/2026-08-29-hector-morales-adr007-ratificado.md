...
| `vault/03_Architecture/ADRs/_index.md` | `**proposed**` |
| `vault/10_Risk_Governance/Decision_Log.md` | cero menciones |
...
`vault/03_Architecture/ADRs`)"*. Duplicarlo ahí violaría además la regla 1 del vault —un tema, un archivo
...
- **Archivos modificados:** `vault/03_Architecture/ADRs/ADR-007-*`, `vault/03_Architecture/ADRs/_index.md`,
  `vault/15_ML_Models/Indice_Riesgo_ML01.md`, `src/modelos/riesgo.py` (nota de estatus),
  `vault/06_Quality_Testing/Bug_Register.md`, `vault/02_Requirements/Traceability_Matrix.md`
