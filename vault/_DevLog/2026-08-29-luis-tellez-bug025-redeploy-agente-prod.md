...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/06_Quality_Testing/Bug_Register|Bug Register · BUG-025]] · [[vault/08_CICD_DevOps/Cloud_Run_Deploy|Cloud_Run_Deploy §4.4]]
...
- **Archivos:** `.gitignore` (+`gx/`), `vault/08_CICD_DevOps/Cloud_Run_Deploy.md` (§4.4), este DevLog, `vault/_DevLog/_index.md`.
...
- **Edgar (owner de `vault/06_Quality_Testing/Bug_Register.md`):** actualizar BUG-025 a *parcialmente resuelto
