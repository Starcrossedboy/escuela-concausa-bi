...
(`vault/08_CICD_DevOps/scripts/provision-gcp-fase1.sh`): cada recurso se crea sólo si no
...
- **Archivos creados/modificados:**
  - `vault/08_CICD_DevOps/scripts/provision-gcp-fase1.sh` (nuevo, idempotente)
  - `vault/_DevLog/2026-08-29-luis-tellez-us504-provision-gcp-fase1.md` (este)
  - `vault/_DevLog/_index.md` (fila)
  - `vault/02_Requirements/Traceability_Matrix.md` (evidencia US-504 en REQ-005)
  - `vault/08_CICD_DevOps/_index.md` (referencia al script)
