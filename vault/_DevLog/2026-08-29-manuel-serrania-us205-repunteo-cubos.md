...
- **`vault/04_UX_Design/Cube_Specs_DB05_DB08.md` → v1.1:** frontmatter (+US-205), §2.1/§2.2/§3.1/§3.2/
...
- **Archivos creados/modificados:**
  ...
  - `vault/04_UX_Design/Cube_Specs_DB05_DB08.md` (v1.1)
  ...
  - `vault/02_Requirements/Traceability_Matrix.md` (conteos/descripciones de tests semánticos)
