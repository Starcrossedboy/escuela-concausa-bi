...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/12_Roadmap_Sprints/Sprints/1-deni-garrido-fragoso]]
...
La actualización de `vault/02_Requirements/Traceability_Matrix.md` queda para Edgar/PM,
