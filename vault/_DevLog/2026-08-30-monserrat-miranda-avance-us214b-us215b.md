...
- `vault/04_UX_Design/Cube_Specs_DB05_DB08.md` §3.4: ruta DB-05→DB-08 pasa de "⬜ Propuesta" a "✅
...
`vault/06_Quality_Testing/Usability_Accessibility_Test_Plan_DB05_DB08.md` (nuevo, `DOC-USABILIDAD-DB0508`),
calcando el formato de `Physical_Test_Plan.md`. Adapta (no copia íntegro) el checklist de
`vault/04_UX_Design/Accessibility.md`, acotado a lo verificable en un dashboard de Superset embebido —
...
- `vault/04_UX_Design/Cube_Specs_DB05_DB08.md` — §3.4 ratificada
- `superset/semantic/metrics_db05_db08.yaml` — `drill_down:` +DB-05→DB-08
- `vault/06_Quality_Testing/Usability_Accessibility_Test_Plan_DB05_DB08.md` (nuevo)
- `vault/06_Quality_Testing/_index.md`
- `vault/06_Quality_Testing/Bug_Register.md` — nota fechada en BUG-027 (severidad low→medium), BUG-037 nuevo
- `vault/12_Roadmap_Sprints/Sprints/2-monserrat-xcaret-miranda-olivas.md` — §9 actualizado
- `vault/02_Requirements/Traceability_Matrix.md` — fila REQ-002, evidencia de US-214b/US-215b
