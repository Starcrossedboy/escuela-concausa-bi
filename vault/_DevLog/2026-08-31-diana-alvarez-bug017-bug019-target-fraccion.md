...
[[vault/03_Architecture/ADRs/ADR-007-unidad-target-variacion-matricula|ADR-007]] se ratificó el
...
- `vault/06_Quality_Testing/Bug_Register.md` (BUG-017, BUG-019 → fixed)
