...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/02_Requirements/Traceability_Matrix|Matriz de trazabilidad]]
...
Luis Téllez — ver [[vault/_DevLog/2026-09-01-luis-tellez-ruff-toml-gate-lint|DevLog del ruff.toml]]).
Ese archivo usa `[lint.per-file-ignores]` para **exonerar los 58 hallazgos preexistentes** por
carpeta (`src/api/**`, `dags/**`, `vault/_Meta/**`, `scripts/**`, `src/frontend/**`, `src/ingesta/**`,
