...
→ [[vault/_DevLog/_index|Volver al índice]] · [[vault/06_Quality_Testing/Bug_Register|BUG-025]]
...
- **Resolución del conflicto de #152**: la rama de Andrés chocaba con `main` solo en
  `vault/_DevLog/_index.md` (índice de bitácoras). Con autorización, integré `origin/main` en su rama
